          ...
          >
              <nav className={styles.navCont}>
                  <div className={styles.navImgCont}>
                      <Link href="/">
                          ...
                          <Image src="/MTClogoMd.png" alt="logo" height={100} width={100}/>
                  ...
                  <div className={styles.navLinkCont}>
                      ...
                      <div>
                          <button className={styles.navBtn}><Link href="/contact">Get A Free <br/> Estimate</Link></button>
                      </div>
                  </div>
              </nav>
              <nav className={styles.navContMobile}>
                  <div className={styles.navLogoMobile}>
                      <Link href="/">
                          <Image src="/MTClogoMd.png" alt="logo" height={50} width={50}/>
                      </Link>
                  </div>
                  <div>
